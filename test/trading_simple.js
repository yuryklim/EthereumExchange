...
contract('trading_simple', function(accounts) {
  before(function(){
    var instanceExchange;
    var instanceToken;
    return exchange.deployed().then(function(instance){
      instanceExchange = instance;
      return instanceExchange.depositEther({from: accounts[0], value: web3.toWei(5, "ether")});
      ...
      instanceToken.approve(instanceExchange.address, 2000);
    }).then(function(txResult){
  ...
  it("should be possible to add a limit buy order", function(){
    ...
    return exchange.deployed().then(function(instance){
      ...
      assert.equal(orderBook[0], 0, "BuyOrderBook should have 0 buy offers");
